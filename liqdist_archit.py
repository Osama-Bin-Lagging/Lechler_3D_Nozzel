...
def select_ipcamera():
    ...
    if PRODUCTION_MODE:
        ...
        if selector == '1': 
            ...
            image_path = "./output_frames/max_area_frame_10.130.191.134_01_20240628141844680_2_2.png"
        ...
        image_path = "./output_frames/max_area_frame_10.130.191.134_01_20240628141844680_2_8.png"
...
def morphologic(img_crop):
    img_gray = cv2.cvtColor(img_crop, cv2.COLOR_BGR2GRAY) #img_crop
...
def find_balls(img_raw,img_undist,output_dir,filename,count):
    ...
    if PRODUCTION_MODE:
        ...
        each_cylinder_width_mm = 15 #int(input("Enter the width of Cylinders in mm"))
        each_cylinder_height_cm = 16.6 #float(input("Enter the Height of Cylinders in cm"))
    if DEBUG_MODE:
        no_of_cylinders = 75
    ...
    if PRODUCTION_MODE:
        no_of_data_points = 23 #int(input("Enter the number of data points you want to use for conversion"))
